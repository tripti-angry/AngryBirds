...
public class LoseScreen implements Screen {
    ...
    public LoseScreen(MainGame game) {
        ...
        loseTexture = new Texture(Gdx.files.internal("ui/levelfailed.png"));

        Image loseImage = new Image(loseTexture);
        loseImage.setSize(viewport.getWorldWidth(), viewport.getWorldHeight());
        ...
        setButtonProperties(menuBtn, 640, 220, 190, 180);
        setButtonProperties(replayBtn, 850, 200, 200, 200);
        setButtonProperties(nextBtn, 1075, 220, 190, 180);
